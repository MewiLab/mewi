...
class Settings(BaseSettings):
    ...
    # Deployment mode — set MINIMAL_MODE=true to skip Supabase/Redis/agent on startup.
    # Useful for cloud payload-testing deployments where only /intake and /health are needed.
    minimal_mode: bool = False

    # Supabase — required in full mode; may be left empty in minimal mode
    supabase_url: str = ""
